...
plt.semilogy(t_central_vd2,f_neta_central_vd2,'b',label='vd=2',lw=0.7,zorder=2)
plt.semilogy(t_central_vd4,f_neta_central_vd4,'g',label='vd=4',lw=0.7,zorder=2)
plt.semilogy(t_central_vd10,f_neta_central_vd10,'r',label='vd=10',lw=0.7,zorder=2)
...
pylab.savefig('f_neta_vds_log.eps', format='eps', dpi=300, bbox_inches='tight')
