...
data = np.genfromtxt("out_forces_225p_1.2m_bcok.txt", delimiter = ' ')

vd= np.linspace(2,17,16)
print(vd)
f_desired = data[:,0]
f_social = data[:,1]
f_granular = data[:,2]
...
pylab.savefig('fsocial_bc_225p_ok.eps', format='eps', dpi=300, bbox_inches='tight')