...
for i in range(0,11):
     ...
     #print(f_total)
     #print(f_granular[i])
     roz_social+=[f_granular[i]/f_social[i]]
...
plt.plot(vd,roz_social,'b',lw=1.0,zorder=2)  
...
pylab.ylabel('Froz/~fsocial')
#pylab.legend()
#pylab.ylim(20, 80)
#pylab.xlim(0, 6)
#lgd=plt.legend() 
#lgd.set_visible(False) 
pylab.savefig('froz_social_1.2m_225p_centrobc.eps', format='eps', dpi=300, bbox_inches='tight')