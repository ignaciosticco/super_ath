...
pylab.figure(1)
pylab.clf()
plt.hist(bc2,bins=20) 
pylab.xlim(0,20)
plt.xlabel('BC size (number of pedestrians)')
plt.ylabel('Ocurrence')
plt.savefig('bc_size_225p_v4_g0_s0.eps', format='eps', dpi=300, bbox_inches='tight')
...
plt.ylabel('Ocurrence')
plt.savefig('bc_time_225p_v4_g0_s0.eps', format='eps', dpi=300, bbox_inches='tight')
