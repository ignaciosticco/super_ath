...
data = np.genfromtxt("in_print_225p_g0_v10_block.txt",  delimiter = ' ')
...
print('Size medio de BC: ',np.mean(bc))
print('Error size BC: ',np.std(bc))
...
pylab.figure(2)
pylab.clf()
plt.hist(t_medio(bc)[2], bins='auto') 
pylab.xlim(0,2)
