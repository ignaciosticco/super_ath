...
### Grafica numero de evacuados vs time a secas (el dato crudo).
...
pylab.figure(1)
pylab.clf()
plt.plot(time,evacuated,'k',lw=1,zorder=2) 
...
pylab.savefig('burst_225p_g0_v2.5.eps', format='eps', dpi=300, bbox_inches='tight')


pylab.figure(2)
pylab.clf()
plt.plot(time2,evacuated2,'k',lw=1,zorder=2) 
#pylab.xticks(np.arange(6,14,1))
#pylab.yticks(np.arange(0,6,1))
pylab.xlabel('time~(s)')
pylab.ylabel('Number of evacuated')
...
#lgd=plt.legend(numpoints=1,handlelength=0.8) 
#lgd.set_visible(True)   
pylab.savefig('burst_225p_g0_v4.eps', format='eps', dpi=300, bbox_inches='tight')

pylab.figure(3)
pylab.clf()
plt.plot(time3,evacuated3,'k',lw=1,zorder=2) 
#pylab.xticks(np.arange(6,14,1))
#pylab.yticks(np.arange(0,6,1))
pylab.xlabel('time~(s)')
pylab.ylabel('Number of evacuated')
...
#lgd=plt.legend(numpoints=1,handlelength=0.8) 
#lgd.set_visible(True)   
pylab.savefig('burst_225p_g0_v10.eps', format='eps', dpi=300, bbox_inches='tight')