...
pylab.savefig('burst2_225p_g0_v2.5.eps', format='eps', dpi=300, bbox_inches='tight')
...
#lgd=plt.legend(numpoints=1,handlelength=0.8) 
#lgd.set_visible(True)   
pylab.savefig('burst2_225p_g0_v4.eps', format='eps', dpi=300, bbox_inches='tight')
...
#lgd=plt.legend(numpoints=1,handlelength=0.8) 
#lgd.set_visible(True)   
pylab.savefig('burst2_225p_g0_v10.eps', format='eps', dpi=300, bbox_inches='tight')
